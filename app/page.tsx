...
const roles = [
  { href: "/dashboard", title: "Coach", text: "Run your team, availability, matches and messages." },
  { href: "/player", title: "Player", text: "See your schedule, availability and development." },
...
export default function Home() {
  return (
    <main className="min-h-screen bg-slate-950 p-6 text-white">
      <div className="mx-auto flex min-h-[90vh] max-w-4xl items-center justify-center">
